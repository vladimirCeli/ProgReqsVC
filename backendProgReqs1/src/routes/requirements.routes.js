...
const { getAllRequirements, getRequirement, getRequirementByProject, createRequirement, deleteRequirement, updateRequirement } = require('../controllers/requirements.controllers')
